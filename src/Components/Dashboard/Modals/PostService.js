...
const PostService = () => {
    ...
    const onSubmitPostService = data => console.log("post", data);
        ...
        <div>
            ...
            >
                <div className="modal-dialog">
                    <form onSubmit={handleSubmit(onSubmitPostService)}>
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title" id="exampleModalLabel">Modal title2</h5>
                                <button
                                    type="button"
                                    className="btn-close"
