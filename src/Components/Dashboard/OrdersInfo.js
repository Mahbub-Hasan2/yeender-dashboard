                ...
                <div className="col-sm-6 col-md-6 col-lg-4">
					<div className="card bg-white p-3 mb-4 shadow">
						<div className="d-flex justify-content-between mb-4">
							<div className="user-info">
								<div className="user-info__img">
									<img src="https://kiranworkspace.com/demo/projects/code-snippets/card/appointment-card/img/user2.jpg" alt="User Img"/>
								</div>
								<div className="user-info__basic">
									<h5 className="mb-0">Sandeep Hegde</h5>
									<p className="text-muted mb-0">28 yrs, Male</p>
								</div>
							</div>
							<div className="dropdown open">
                ...
                <div className="col-sm-6 col-md-6 col-lg-4">
					<div className="card bg-white p-3 mb-4 shadow">
						<div className="d-flex justify-content-between mb-4">
							<div className="user-info">
								<div className="user-info__img">
									<img src="https://kiranworkspace.com/demo/projects/code-snippets/card/appointment-card/img/user3.jpg" alt="User Img"/>
								</div>
								<div className="user-info__basic">
                ...
                <div className="col-sm-6 col-md-6 col-lg-4">
					<div className="card bg-white p-3 mb-4 shadow">
						<div className="d-flex justify-content-between mb-4">
							<div className="user-info">
								<div className="user-info__img">
									<img src="https://kiranworkspace.com/demo/projects/code-snippets/card/appointment-card/img/user7.jpg" alt="User Img"/>
								</div>
								<div className="user-info__basic">
									<h5 className="mb-0">Vishwanath</h5>
									<p className="text-muted mb-0">28 yrs, Male</p>
								</div>
							</div>
							<div className="dropdown open">
                ...
                <div className="col-sm-6 col-md-6 col-lg-4">
					<div className="card bg-white p-3 mb-4 shadow">
						...
						<div className="d-flex justify-content-between mt-4">
							<div>
								<h5 className="mb-0">06:30 PM
									<small className="ml-1">3 Feb 2021</small>
								</h5>
							</div>
							<span className="text-primary font-weight-bold">Revisit</span>
						</div>
					</div>
				</div>
